...
class Case1() {
    enum class A {
        ...
        fun f() {
            <!DEBUG_INFO_AS_CALL("fqName: testPackage.Case1.A.invoke; typeCall: variable&invoke; ")!>foo()<!>
            <!DEBUG_INFO_AS_CALL("fqName: testPackage.Case1.A.invoke; typeCall: function; ")!>foo.invoke()<!>
        }
